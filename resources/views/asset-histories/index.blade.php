                    ...
                    <div class="block w-full h-auto p-0 m-0 overflow-hidden">
                        <div class="flex justify-between items-center flex-wrap gap-2 w-full min-h-[64px] h-auto p-2 my-2 break-all relative sm:m-0">
                            ...
                            <div class="block w-auto h-auto px-2 py-0.5 m-0 overflow-hidden relative basis-full order-3 sm:basis-auto sm:order-none">
                                <form class="contents w-auto h-auto p-0 m-0 relative" action="{{ route('asset-histories.index') }}" method="GET" autocomplete="off" autocapitalize="off">
                            ...
                            @ability(App\Enums\RoleEnum::Administrator->value, App\Enums\PermissionEnum::CreateAssetHistories->value)
                                <div class="flex justify-start items-center gap-2 w-auto h-auto p-0 m-0 overflow-hidden relative basis-auto order-2 sm:order-none">
                                    @permission(App\Enums\PermissionEnum::CreateAssetHistories->value)
                                        <div class="inline-block w-auto h-auto p-0 m-0 relative">

                                            {{-- Icon Link --}}
                                            <div class="block w-auto h-auto p-0 m-0 relative">
                                                <a href="{{ route('asset-histories.create') }}" class="block w-10 h-10 p-2 m-0 bg-transparent rounded-full text-black/[0.60] outline-none cursor-pointer align-middle transition duration-150 ease-in-out hover:bg-black/[0.04] active:bg-black/[0.10] focus:bg-black/[0.12] dark:text-white/[0.60] dark:hover:bg-white/[0.04] dark:active:bg-white/[0.10] dark:focus:bg-white/[0.12]" data-te-toggle="tooltip" title="Buat" data-te-ripple-init data-te-ripple-color="light">
                                                    <svg class="pointer-events-none w-full h-full fill-current" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#000000">
                                                        <path d="M0 0h24v24H0z" fill="none" />
                                            ...
                                            <tr class="table-row text-inherit align-middle outline-none relative">
                                                ...
                                                <td class="table-cell w-auto h-[52px] px-4 m-0 body-2 text-black/[0.87] text-center truncate dark:text-white/[0.87]">
                                                    @ability(App\Enums\RoleEnum::Administrator->value, [
                                                        ...
                                                        App\Enums\PermissionEnum::UpdateAssetHistories->value,
                                                        App\Enums\PermissionEnum::DeleteAssetHistories->value,
                                                    ])
                                                        <div class="inline-block w-auto h-auto p-0 m-0 relative">
                                                                ...
                                                                <ul class="hidden min-w-[128px] w-auto max-w-[280px] h-auto py-2 m-0 list-none rounded bg-white shadow-08dp absolute top-full right-0 z-10 [&[data-te-dropdown-show]]:block dark:bg-charleston-green" data-te-dropdown-menu-ref>
                                                                    @permission(App\Enums\PermissionEnum::ReadAssetHistories->value)
                                                                        <li class="block w-full h-auto p-0 m-0 overflow-hidden relative">
                                                                            <a href="{{ route('asset-histories.show', $history->id) }}" class="flex justify-between items-center gap-4 w-full h-10 py-2 px-4 m-0 body-2 text-black/[0.60] no-underline outline-none truncate select-none hover:bg-black/[0.04] active:bg-black/[0.10] focus:bg-black/[0.12] dark:text-white/[0.60] dark:hover:bg-white/[0.04] dark:active:bg-white/[0.10] dark:focus:bg-white/[0.12]" data-te-dropdown-item-ref data-te-ripple-init data-te-ripple-color="light">
                                                                                <div class="inline-block w-auto h-auto p-0 m-0 relative">
                                                                                    <svg class="pointer-events-none w-full h-full fill-current" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#000000">
                                                                                        <path d="M0 0h24v24H0z" fill="none" />
                                                                    ...
                                                                    @permission(App\Enums\PermissionEnum::UpdateAssetHistories->value)
                                                                        <li class="block w-full h-auto p-0 m-0 overflow-hidden relative">
                                                                            <a href="{{ route('asset-histories.edit', $history->id) }}" class="flex justify-between items-center gap-4 w-full h-10 py-2 px-4 m-0 body-2 text-black/[0.60] no-underline outline-none truncate select-none hover:bg-black/[0.04] active:bg-black/[0.10] focus:bg-black/[0.12] dark:text-white/[0.60] dark:hover:bg-white/[0.04] dark:active:bg-white/[0.10] dark:focus:bg-white/[0.12]" data-te-dropdown-item-ref data-te-ripple-init data-te-ripple-color="light">
                                                                                <div class="inline-block w-auto h-auto p-0 m-0 relative">
                                                                                    <svg class="pointer-events-none w-full h-full fill-current" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#000000">
                                                                                        <path d="M0 0h24v24H0z" fill="none" />
                                                                    ...
                                                                    @permission(App\Enums\PermissionEnum::DeleteAssetHistories->value)
                                                                        <li class="block w-full h-auto p-0 m-0 overflow-hidden relative">
